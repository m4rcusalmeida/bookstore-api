...
public class CategoriaController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<CategoriaDto> update(@PathVariable Long id, @RequestBody CategoriaDto catDto) {
		Categoria newCategoria = categoriaService.update(id, catDto);
